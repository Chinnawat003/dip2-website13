...
<?php
$id = $_GET['id'];
$sql = "UPDATE hotnews SET hotcount=hotcount+1 WHERE id='$id'";
...
<?php
$id = $_GET['id'];
$sql = "select*from hotnews where id='$id' ";
$result = mysqli_query($con, $sql);
            ...
            <div class="card shadow">
                <div class="card-body d-flex flex-row ">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-2">
                                <img src="images/logotrat.png" class="rounded-circle mr-3" width="100px" alt="avatar">
                            </div>
                            <div class="col-md-8">
